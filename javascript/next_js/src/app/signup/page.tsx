...
const Signuppage = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center   min-h-screen border border-white">
      <h1 className='text-lg text-white'>Signup Page</h1> <br />
      <div className="forms space-y-4 p-6 bg-gray-100 rounded-lg shadow-md  mx-auto">
        ...
        <div>
          ...
          <input
            ...
            className=" cursor-pointer w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        <button
