      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-grow text-lg leading-relaxed text-white dark:text-gray-200 text-center md:text-left"> 
            <p className="mb-4">
              I'm currently in my <b>2nd year</b> of pursuing a Bachelor of Computer Applications (BCA) at <b>Symbiosis Institute of Computer Studies and Research (SICSR)</b> in Pune, Maharashtra. This program is providing me with a strong foundation in computer science principles and modern development practices.
            </p>
            <p className="mb-4">
            ...
            <p>
              I'm constantly exploring new technologies, with a current deep dive into <b>Next.js</b>. Though I'm eager for my first professional experience, I bring a strong drive to learn, adapt, and contribute to innovative web solutions.
            </p>
          </div>
        </div>
      </div>
